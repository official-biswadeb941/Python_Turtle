...
#    sys.setExecutionLimit(35000)
    ...
    size1 = 35 # Height for main body letters

    size2 = 25  # Height for smaller letters
    ...
    next_char(turt1, size2)  # Prints a space between words
    ...
    turt1.color("black")  # Turns the cursor white to hide it
